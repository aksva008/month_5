...
from product.serializers import CategoryListSerializer, CategoryValidateSerializer, ProductDetailSerializer, ProductListSerializer, ProductReviewSerializer, ProductValidateSerializer, ReviewValidateSerializer, ReviewListSerializer
...
def products_detail_api_view(request, product_id):
    ...
    if request.method == 'PUT':
        ...
        product.title = serializer.validated.data.get("title")
        product.description = serializer.validated.data.get("description")
        product.price = serializer.data.get("price")
        product.category_id = serializer.data.get('category_id') 
        product.rating.set(serializer.data.get('rating'))
        product.save()
